<template>
  <div class="mdl-grid">
    ...
    <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-phone">
      ...
      <div v-if="isOnline" class=" mdl-grid center-items">
        <autocomplete
  ...
  <div v-else class=" mdl-grid center-items">
    <p>Impossible to add new routes when offline.</p>
  </div>
...
export default {
  ...
  mounted: function () {
    ...
    // $nextTick permet d'attendre que la vue entière a bien été rendue avant d'executer le callback
